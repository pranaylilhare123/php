...
$qry = "INSERT INTO `registerdb`(`id`, `fullname`, `email`, `password`, `mobile`) VALUES ('NULL','$fn','$eid','$pwd','$mob')";
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="fullname" label="fullname" placeholder="email" name="email" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <button class="btn btn-success" type="submit" name="registerbtn" >submit  </button>
                        </div>
